      ...
      <div className="ui-wrapper">
        ...
        <div className="select-wrapper">
          <ul>
            ...
            <li className="India"><label htmlFor="India"><span>IN</span>India (+91)</label></li>
            ...
            <li className="Czech"><label htmlFor="Czech"><span>🇨🇿</span>Czech Republic (+420)</label></li>
            ...
            <li className="Ireland"><label htmlFor="Ireland"><span>🇮🇪</span>Republic of Ireland (+353)</label></li>
